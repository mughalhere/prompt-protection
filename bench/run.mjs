...
const gates = [
  ...
  ['agent-flows tool-drift agreement = 100%', scenarioAgreement('tool-drift') === 1],
  ['agent-flows loop-budget agreement = 100%', scenarioAgreement('loop-budget') === 1],
  ['agent-flows depth-budget agreement = 100%', scenarioAgreement('depth-budget') === 1],
